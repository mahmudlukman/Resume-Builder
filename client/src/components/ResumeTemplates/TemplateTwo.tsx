...
const TemplateTwo = ({ resumeData, colorPalette, containerWidth }: { resumeData: ResumeData; colorPalette: string[]; containerWidth: number }) => {
        ...
        <div className="mt-4">
          ...
          {resumeData?.workExperience?.map((data, index) => (
            <WorkExperience
              ...
              role={data.role ?? ""}
              duration={`${formatYearMonth(data.startDate ?? null)} - ${formatYearMonth(
                data.endDate ?? null
              )}`}
