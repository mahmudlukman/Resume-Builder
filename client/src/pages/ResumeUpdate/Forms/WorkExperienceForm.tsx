...
interface WorkExperienceFormProps {
  ...
  updateArrayItem: (index: number, field: keyof WorkExperience, value: string) => void;
  addArrayItem: (item: WorkExperience) => void;
  removeArrayItem: (index: number) => void;
}

const WorkExperienceForm = ({workExperience, updateArrayItem, addArrayItem, removeArrayItem}: WorkExperienceFormProps) => {
  return (
