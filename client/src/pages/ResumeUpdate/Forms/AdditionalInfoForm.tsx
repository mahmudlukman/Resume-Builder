...
interface AdditionalInfoFormProps {
  ...
  interests: string[];
  updateArrayItem: (section: keyof ResumeData, index: number, field: string | null, value: string | number) => void;
  addArrayItem: (section: string, value: string | number | { name: string; progress: number }) => void;
