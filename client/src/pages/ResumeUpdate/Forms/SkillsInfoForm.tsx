...
interface SkillsInfoFormProps {
  skillsInfo: Skill[];
  updateArrayItem: (index: number, field: string, value: string | number) => void;
  addArrayItem: (item: Skill) => void;
  removeArrayItem: (index: number) => void;
}

const SkillsInfoForm = ({skillsInfo, updateArrayItem, addArrayItem, removeArrayItem}: SkillsInfoFormProps) => {
  return (
